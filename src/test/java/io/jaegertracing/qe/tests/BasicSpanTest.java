...
public class BasicSpanTest extends TestBase {
    ...
    /* Test: Create single span, send it to server and do validate it via query api.
     * Steps:
     * 1. Create a span
     * 2. send it to server
    ...
    /* Test: Create parent span and child span
     * Steps:
     * 1. Create parent span and child span
     * 2. validate from server
     */
    @Test
    public void spanWithChildTest() {
        ...
        io.jaegertracing.qe.rest.model.Span span1 = getSpan(spans, "parent-span");
